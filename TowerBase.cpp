...
void BottleTower::playAttackAnimation() {
    ...
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Bottle.mp3"); //播放炮塔攻击音效
...
void SunflowerTower::playAttackAnimation() {
    ...
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Sun.mp3"); //播放炮塔攻击音效
    // 太阳特效
    bullet->runAction(
        Sequence::create(
...
void StarTower::playAttackAnimation() {
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Star.mp3"); //播放炮塔攻击音效
    cooldownTimer = attackInterval;
    // 没有开火动画
}
...
void ShitTower::playAttackAnimation() {
    ...
    CocosDenshion::SimpleAudioEngine::getInstance()->playEffect("Shit.mp3"); //播放炮塔攻击音效
    bullet->runAction(
        Sequence::create(
            FadeOut::create(0.1f),// 淡出
            RemoveSelf::create(),// 移除金币图像
            nullptr)
    );
}
